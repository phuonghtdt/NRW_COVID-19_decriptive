...
#method1:
# plot mean contact
ggplot(df, aes(x=wave_date, y=all_contact_n))+ 
...
ggplot(df, aes(x=wave_date, y=hh_contact_n))+ 
    stat_summary(geom="ribbon", fun.data=mean_cl_normal, 
                 fun.args=list(conf.int=0.95), fill="lightblue")+
    stat_summary(geom="line", fun=mean, linetype="dashed")+
    stat_summary(geom="point", fun=mean, color="red")+
...
ggplot(df, aes(x=wave_date, y=non_hh_contact_n))+ 
    stat_summary(geom="ribbon", fun.data=mean_cl_normal, 
                 fun.args=list(conf.int=0.95), fill="lightblue")+
    stat_summary(geom="line", fun=mean, linetype="dashed")+
    stat_summary(geom="point", fun=mean, color="red")+
  # scale_x_continuous(breaks = seq(1,current_wave,2))+
   coord_cartesian( ylim = c(0, 6))+
  labs(y="Mean_contact_non_hh", x="Start date of each week")+
...
ggplot(dt, aes( x=wave_date, y=value, colour=variable, fill=variable ))+ 
  ...
  labs(y="Mean_contacts",x="Start date of each week")+
...
do.call(grid.arrange,plot_list[1:9])
do.call(grid.arrange,plot_list[10:18])
do.call(grid.arrange,plot_list[19:27])
do.call(grid.arrange,plot_list[28:current_wave])
...
# rolling average
 mobi <- mobi %>%mutate(
      cx_7da = zoo::rollmean(cx, k = 7, fill = NA),
      k_7da = zoo::rollmean(k, k = 7, fill = NA))
...
# Number of contact 
## origin data
p1 <-  ggplot(mobi1,aes( x = date)) +
   # geom_point(aes(y = k_7da, color = "red") )+
   geom_line( aes(y = k),color = "blue")+
   labs(y="Number of contact",x="", fill = "")+
   ylim (0,30)+
   ggtitle("Number of contacts over time in NRW (mobility data) " )+
...
## rolling average
p2 <- ggplot(mobi1,aes( x = date)) +
   # geom_point(aes(y = k_7da, color = "red") )+
   geom_line( aes(y = k_7da),color = "blue")+
   labs(y="Rolling contacts_7 days",x="", fill = "")+
    ylim (0,30)+
   ggtitle("Number of contacts over time in NRW (mobility data) " )+
   scale_x_date(breaks = "21 days")+ # display all dates on x axis
   theme_classic()+
...
p1 <-  ggplot(mobi1,aes( x = date)) +
  # geom_point(aes(y = k_7da, color = "red") )+
  geom_line( aes(y = cx),color = "blue")+
  labs(y="Contact index(CX)",x="", fill = "")+
  ylim(0,1500)+
  ggtitle("Contact index (CX) over time in NRW (mobility data) " )+
  scale_x_date(breaks = "21 days")+ # display all dates on x axis
  theme_classic()+
  theme(axis.text.x = element_text(colour = "black", size = 10, angle = 90, hjust = 0.5, vjust = 0,5),
        axis.text.y = element_text(colour = "black", size = 15, face = "bold"),
...
p2<- ggplot(mobi1,aes( x = date)) +
  # geom_point(aes(y = k_7da, color = "red") )+
  geom_line( aes(y = cx_7da),color = "blue")+
  labs(y="Rolling (CX)_7 days",x="", fill = "")+
  ylim(0,500)+
  ggtitle("Contact index (CX) over time in NRW (mobility data) " )+
  scale_x_date(breaks = "21 days")+ # display all dates on x axis
  theme_classic()+
...
google_melt <- melt(google,id.vars = "date") # id.vars is variable that you don't want to melt
ggplot(google_melt,aes( x = date, y = value, color = variable)) +
   geom_line(size =1)+
...
```{r}
# Retail/Recreation
p1 <- ggplot(google,aes( x = date)) +
  # geom_point(aes(y = k_7da, color = "red") )+
  geom_line( aes(y = retail_recreation),color = "blue")+
  # geom_line( aes(y = grocery_pharmac),color = "blue")+
  # geom_line( aes(y = parks),color = "blue")+
  # geom_line( aes(y = transit_stations),color = "blue")+
  # geom_line( aes(y = workplaces),color = "blue")+
  # geom_line( aes(y = residential),color = "blue")+
  geom_hline(yintercept=0, linetype="dashed", 
             color = "red", size=1)+
  labs(y="",x="", fill = "")+
...
ggarrange(p1+rremove("x.text"),
          p2+rremove("x.text")+rremove("y.text"),
          p3+rremove("x.text"),
          p4+rremove("x.text")+rremove("y.text"),
          p5,
          p6+rremove("y.text"), 
          labels = c("A", "B"),
          ncol = 2, nrow = 3)
