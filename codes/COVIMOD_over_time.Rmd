...
path_contact_pattern <- "C:/Users/huynh/sciebo/NRW_descriptive/results/covimod_NRW_valid code/contact_pattern"
...
dummy$place_oth <- as.numeric(dummy$place_oth)# why place_oth is all NA ?
...
This chunk deals with the problem of different hh_p_inc variables. 
 ...
 Variable "hh_p_incl_new_0" does not exist!!!!
```{r merge households}
# Haushaltsgrößen
...
c_pattern <- ggplot(melt_cm_den2, aes(contact.age.group, Var1)) +
  ...
  coord_equal() +
  ggtitle(paste0("Wave",wave_n, "(31/3/21 - 07/4/21)")) +
