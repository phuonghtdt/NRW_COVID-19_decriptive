...
# dt_hh_all$place_multiple <- as.integer(dt_hh_all$place_multiple >= 2) # sum of at least 2 places ## only 0,1 or NA
...
# plot different contacts
ggplot(d_all_wide,aes(factor(wave)))+
  geom_point(aes(y=non_hh_before_onceweek_contact_n),stat="summary",fun ="mean",col="red")+
  geom_point(aes(y=non_hh_before_oncemonth_contact_n),stat="summary",fun ="mean", col ="blue")

# plot mean contact
ggplot(d_all_wide,aes(factor(wave),all_contact_n))+
  # geom_line(aes(y=all_contact_n))+
...
#Summary
##calculate all hh contacts and outside contacts
...
## Calculation all non-hh-contacts
