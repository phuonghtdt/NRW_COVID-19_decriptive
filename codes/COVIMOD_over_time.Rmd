...
```{r Vectors to use}
 ...
 wave_date <- c("30.04.2020",
           ...
           "03.11.2021", 
           "17.11.2021",
           "30.11.2021") # this may not true, ask Veronika
...
ggplot(df, aes(x=wave_date, y=all_contact_n))+ 
  ...
  coord_cartesian( ylim = c(0, 6))+
   ggtitle("All contact")+
  labs(y="Mean_all_contact",x="Start date of each wave")+
...
ggplot(df, aes(x=wave_date, y=hh_contact_n))+ 
  ...
  # scale_x_continuous(breaks = seq(1,current_wave,2))+
   coord_cartesian( ylim = c(0, 6))+
  labs(y="Mean_contact_hh",x="Start date of each wave")+
...
This is restricted to participant has more than 25 times
...
do.call(grid.arrange,plot_list[28:32])
