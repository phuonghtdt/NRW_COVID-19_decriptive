...
There is a shift in age structure among COVID-19 infections, especially since wave 4. 
...
dat%>%
  ...
  ggplot()+
  geom_line(aes(y=case_n, x=rep_week_date), size=1, colour="blue") +
 scale_x_date(date_labels="%Y-%m-%d", date_breaks = "14 days",
               limits = c(as.Date("2020-03-01"),as.Date("2021-12-30")),
               expand = c(0, 0)) +
  labs(x = " ", y = "Reported number.") +
...
hosp_melt%>%
  ...
  ggplot()+
  geom_line(aes(y=value, x=rep_week_date,color=variable)) +
  scale_x_date(date_labels="%Y-%m-%d", date_breaks = "14 days",
               limits = c(as.Date("2020-03-01"),as.Date("2021-12-30")),
               expand = c(0, 0)) +
  labs(x = " ", y = "Reported number", color="") +
...
hosp%>%
  ...
  ggplot()+
  geom_line(aes(y=ICU, x=rep_week_date), size=1, colour="blue") +
  scale_x_date(date_labels="%Y-%m-%d", date_breaks = "14 days",
               limits = c(as.Date("2020-03-01"),as.Date("2021-12-30")),
               expand = c(0, 0)) +
  labs(x = " ", y = "Reported number") +
