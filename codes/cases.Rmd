...
reg_bund <- reg_bund %>% select(-c(ags2, bundesland))
...
dat_week_dummy <- dat_week %>%
  ...
  select(rep_week_date,case,case_scaled)%>%
...
# add GISD data
dat_county <- merge(dat_county, gisd %>%select(county,GISD_5,pop_n), by = "county")
...
dat_county <- dat_county%>%
  mutate(case_perwk_100k_w1 = case_wave1/duration_w1/pop_n*100000,
         case_perwk_100k_w2 = case_wave2/duration_w2/pop_n*100000,
         case_perwk_100k_w3 = case_wave3/duration_w3/pop_n*100000,
         case_perwk_100k_w4 = case_wave4/duration_w4/pop_n*100000)

dat_county <- dat_county %>% select (-c("pop_n"))# avoid duplicated later
